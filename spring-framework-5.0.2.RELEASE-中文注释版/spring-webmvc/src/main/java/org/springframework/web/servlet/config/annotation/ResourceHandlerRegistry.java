...
public class ResourceHandlerRegistry {
	 ...
	 * path patterns.
	 * 增加一个 基于指定 的 URL路径 模式服务静态资源 的 资源处理器
	 *
	 ...
	 */
//		当每次调用 registry.addResourceHandler() 时，实际上它会创建一个 ResourceHandlerRegistration 对象，然后将该对象放到自己的注册表管理起来，
//	函数参数 pathPatterns 表示要映射到 URL pattern, 可以传递多个要映射到的 URL pattern。如下所示 :
