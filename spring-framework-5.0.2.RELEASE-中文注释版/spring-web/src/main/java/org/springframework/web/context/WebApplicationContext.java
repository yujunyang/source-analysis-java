...
//	路径 中装载配置文件完成初始化工作。从 WebApplicationContext 中可以获得
//	ServletContext 的引用，整个 Web 应用上下文对象 将作为 属性 放置到 ServletContext
...
public interface WebApplicationContext extends ApplicationContext {
	 ...
	 */
	// 將 WebApplicationContext 放到 ServletContext 容器中
