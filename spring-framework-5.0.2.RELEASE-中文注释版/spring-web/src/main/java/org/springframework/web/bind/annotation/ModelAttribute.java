 ...
 * @since 2.5
 */
//	该Controller的所有方法在调用前，先执行此@ModelAttribute方法，可用于方法和方法参数中，
//可以把这个@ModelAttribute特性，应用在BaseController当中，所有的Controller继承BaseController，既可实现
//在调用Controller时，先执行@ModelAttribute方法。
...
public @interface ModelAttribute {
	 ...
	 * attribute type (i.e. the method parameter type or metod return type),
