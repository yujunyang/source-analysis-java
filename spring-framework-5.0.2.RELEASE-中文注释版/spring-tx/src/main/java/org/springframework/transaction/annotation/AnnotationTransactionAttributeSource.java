...
public class AnnotationTransactionAttributeSource extends AbstractFallbackTransactionAttributeSource
	 ...
	 */
//		this.annotationParsers 是在当前类 AnnotationTransactionAttributeSource 初始化的时候初始化的，
//	其中的值被加入了 SpringTransactionAnnotationParser,也就是当进行 属性获取 的时候其实是使用
//	SpringTransactionAnnotationParser 类的 parseTransactionAnnotation 方法进行解析的。
	@Nullable
	protected TransactionAttribute determineTransactionAttribute(AnnotatedElement ae) {
		for (TransactionAnnotationParser annotationParser : this.annotationParsers) {
			/// 根据 @Transaction 注解 获取 AnnotationAttributes ， 解析 AnnotationAttributes 生成 RuleBasedTransactionAttribute
